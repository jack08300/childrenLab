...
<html>
	...
	<body>
		...
		<div id="show-calendarEvent" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:calendarEventInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${calendarEventInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
